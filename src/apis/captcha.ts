...
export function getImageCaptcha() {
  return http.get<ImageCaptchaResp>({ url: `${BASE_URL}/image` })
}
...
export function getBehaviorCaptcha(req: any) {
  return http.get<BehaviorCaptchaResp>({ url: `${BASE_URL}/behavior`, params: req })
}

/** @desc 校验行为验证码 */
export function checkBehaviorCaptcha(req: any) {
  return http.post<CheckBehaviorCaptchaResp>({ url: `${BASE_URL}/behavior`, params: req })
}
